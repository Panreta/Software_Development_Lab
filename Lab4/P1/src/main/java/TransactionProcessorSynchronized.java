...
// Transaction Processor for Synchronized version
public class TransactionProcessorSynchronized {
    private final BankAccountSynchronized account;
    private final int numThreads;
    private final int transactionsPerThread;

    public TransactionProcessorSynchronized(BankAccountSynchronized account,
                                            int numThreads,
    ...
    private static class TransactionWorker implements Runnable {
        ...
        public TransactionWorker(BankAccountSynchronized account, int numTransactions) {
            this.account = account;
